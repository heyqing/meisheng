  ...
  >
    ...
    <el-form ref="formRef" :model="form" label-width="100px" style="text-align: center">
      ...
      <el-upload
        ...
        :action="getServerUrl()+'admin/smallType/uploadImage'"
...
const actionData=ref({id:form.value.categoryId})
...
watch(
  ...
  ()=>{
    ...
    actionData.value.id= form.value.categoryId;
    imageSrc.value=form.value.categoryAvatar;
  },
...
const handleAvatarSuccess = (res) => {
  ...
  form.value.categoryAvatar = res.data;
}
